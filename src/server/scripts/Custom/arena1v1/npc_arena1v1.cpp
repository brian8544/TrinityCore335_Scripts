...
public:
    ...
    bool OnGossipHello(Player* player) override
    {
        ...
        if(player->InBattlegroundQueueForBattlegroundQueueType(BATTLEGROUND_QUEUE_5v5))
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/INV_Misc_EngGizmos_27:30:30:-15:0|t Leave queue 1v1 Arena", GOSSIP_SENDER_MAIN, 3, "Are you sure?", 0, false);
        else
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Achievement_Arena_2v2_4:30:30:-15:0|t Sign up 1v1 Arena (unrated)", GOSSIP_SENDER_MAIN, 20);

        if(player->GetArenaTeamId(ArenaTeam::GetSlotByType(ARENA_TEAM_5v5)) == 0)
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/INV_MISC_NOTE_02:30:30:-15:0|t Create new 1v1 Arenateam", GOSSIP_SENDER_MAIN, 1, "Create 1v1 arenateam?", sWorld->getIntConfig(CONFIG_ARENA_1V1_COSTS), false);
        else
        {
            if(player->InBattlegroundQueueForBattlegroundQueueType(BATTLEGROUND_QUEUE_5v5) == false)
            {
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Achievement_Arena_2v2_7:30:30:-15:0|t Sign up 1v1 Arena (rated)", GOSSIP_SENDER_MAIN, 2);
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Spell_BrokenHeart:30:30:-15:0|t Disband arenateam", GOSSIP_SENDER_MAIN, 5, "Are you sure?", 0, false);
            }

            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/INV_Misc_Book_08:30:30:-15:0|t Show statistics", GOSSIP_SENDER_MAIN, 4);
        }
